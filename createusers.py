...
def createuserData(name, email,number):
    return {
        "username": name,
...
def registerUser(name, email,number):
    data = createuserData(name, email,number)
...
def driver():
    ...
    for i in range(0, 100):
        rslt=registerUser('hellop'+str(i), 'hellop'+str(i)+"email@gmail.com","sdfdsfvfsd"+str(i))
